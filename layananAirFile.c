...
void namaProgram(), namaKelompok(), menuUtama(), menuRT(), totalBiayaD11(), is(), cobaLagi(),
    ...
    akhirProgram(), menuUsaha(), printStruk(char *nama, char *kelompok, char *golongan, int tanggal, int bulan, int tahun, float pakaiAir, float biaya, int denda, int bpm, int admin, float total);

int validasi_Int(), pilihListrik(), inputBulan(), inputTahun();
...
void namaKelompok()
{
    system("clear");
    printf("========================================================\n");
    printf("||            Tugas Individu Dibuat Oleh :            ||\n");
    printf("|| ================================================== ||\n");
    printf("||                                                    ||\n");
...
{
    int bulan;
    range_Validasi_Int(&bulan, 1, 12, "   Bulan (1 -> 12) : ");
    return bulan;
}
...
{
    int tahun;
    range_Validasi_Int(&tahun, 1900, 2022, "   Tahun           : ");
    return tahun;
}

// Fungsi Print Struk difile txt
void printStruk(char *nama, char *kelompok, char *golongan, int tanggal, int bulan, int tahun, float pakaiAir, float biaya, int denda, int bpm, int admin, float total)
{
    char *struk = "struk_PDAM.txt";
    FILE *fp = fopen(struk, "w");
    fprintf(fp, "=========================================================\n");
    fprintf(fp, "||                    Program PDAM                     ||\n");
    fprintf(fp, "||               PT.Blangkon Sejahtera                 ||\n");
    fprintf(fp, "|| =================================================== ||\n");
    fprintf(fp, "||  Struk Pembayaran Air : %s                            \n", nama);
    fprintf(fp, "|| =================================================== ||\n");
    fprintf(fp, "||                                                     \n");
    fprintf(fp, "|| Kelompok Pelanggan : %s                           \n", kelompok);
    fprintf(fp, "|| Golongan           : %s                           \n", golongan);
    fprintf(fp, "|| Tanggal Bayar      : %d/%d/%d                     \n", tanggal, bulan, tahun);
    fprintf(fp, "|| Jatuh Tempo Bayar  : Tanggal %d                     \n", JATUH_TEMPO);
    fprintf(fp, "|| Pemakaian Air      : %2.f      M^3                  \n", pakaiAir);
    fprintf(fp, "|| Biaya Air          : Rp. %2.f,-                       \n", biaya);
    fprintf(fp, "|| Denda              : Rp. %d,-                         \n", denda);
    fprintf(fp, "|| BPM                : Rp. %d,-                         \n", bpm);
    fprintf(fp, "|| Biaya Administrasi : Rp. %d,-                         \n", admin);
    fprintf(fp, "||                                                     \n");
    fprintf(fp, "=========================================================\n");
    fprintf(fp, "|| Total Bayar        : Rp. %2.f,-                       \n", total);
    fprintf(fp, "=========================================================\n");
    fclose(fp);
}
...
void totalBiayaD11()
{
    ...
    int tanggal, denda, bpm, admin, bulan, tahun;
    char nama[100];
    char kelompok[20] = "Rumah Tangga";
    char golongan[10] = "D1-1";
    system("clear");
    printf("========================================================\n");
    printf("||                    Program PDAM                    ||\n");
    printf("||               PT.Blangkon Sejahtera                ||\n");
    ...
    range_Validasi_Int(&tanggal, 1, 31, "   Tanggal Bayar   : ");
    bulan = inputBulan();
    tahun = inputTahun();
    bpm = BPM_RT;
    admin = ADMIN_RT;
    ...
    printStruk(nama, kelompok, golongan, tanggal, bulan, tahun, pakaiAir, biaya, denda, bpm, admin, total);
    printf("=========================================================\n");
...
void totalBiayaE11()
{
    ...
    int tanggal, denda, bpm, admin, bulan, tahun;
    char nama[100];
    char kelompok[20] = "Usaha";
    char golongan[10] = "E1-1";
    system("clear");
    printf("========================================================\n");
    printf("||                    Program PDAM                    ||\n");
    printf("||               PT.Blangkon Sejahtera                ||\n");
...
float pemakaianAir()
{
    ...
    do
    {
        ...
        {
            printf("\nPemakaian Bulan ini tidak boleh lebih kecil dari bulan lalu ! \n\n");
        }
    } while (bulanLalu > bulanIni);
...
void is()
{
    printf("\n========================================================\n");
    printf("||               Maaf, input Anda salah !             ||\n");
    printf("||           Pilihlah sesuai dengan petunjuk          ||\n");
    printf("========================================================\n");
    printf("          Tekan enter untuk mengulang input !           \n");
    getchar();
}
...
void cobaLagi()
{
    ...
    int pilih;
    printf("====================================================\n");
    printf("||         Struk air anda telah dicetak           ||\n");
    printf("====================================================\n");
    printf("          Tekan enter untuk melanjutkan !       \n");
    getchar();
    system("clear");
